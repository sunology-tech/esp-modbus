...
typedef struct {
    ...
    uint16_t gr_reg_start;          /*!< Modbus Starting register (Write General Reference) */
    uint16_t gr_reg_quant;          /*!< Modbus quantity of registers to write (Write General Reference)*/
} mb_param_request_t;
